...
const SoloResult = () => {
  ...
  const { score, wrongCount, timeTaken, isNewAllTimeBest, isNewWeeklyBest, allTimeBest, weeklyBest } = result
...
const styles = {
  ...
  scoreLabel: { color: '#444', fontSize: '0.85rem', textTransform: 'uppercase', letterSpacing: '0.1em' },
  ...
  bestLabel: { color: '#444', fontSize: '0.75rem', textTransform: 'uppercase', letterSpacing: '0.08em' },
  bestScore: { color: '#00ff87', fontSize: '2rem', fontWeight: 700, fontFamily: 'monospace' },
  bestSub: { color: '#333', fontSize: '0.72rem' },
