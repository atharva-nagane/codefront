...
const styles = {
  ...
  breadcrumbItem: { color: '#888', fontSize: '0.78rem', fontFamily: 'monospace', cursor: 'pointer' },
  ...
  exampleBlock: { flex: 1 },
  exampleLabel: { color: '#888', fontSize: '0.7rem', textTransform: 'uppercase', letterSpacing: '0.08em', display: 'block', marginBottom: '0.35rem' },
  ...
  constraint: { color: '#888', fontSize: '0.8rem', fontFamily: 'monospace' },
  tag: { background: '#1a1a1a', color: '#888', padding: '0.15rem 0.5rem', borderRadius: '3px', fontSize: '0.75rem', border: '1px solid #2a2a2a', fontFamily: 'monospace' },
  ...
  metaLabel: { color: '#888', width: '140px', flexShrink: 0 },
